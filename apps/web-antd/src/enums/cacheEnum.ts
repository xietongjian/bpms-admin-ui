...
// personals info key
export const PERSONAL_MAP_KEY = 'PERSONAL__MAP__KEY__';

// project config key
export const PROJ_CFG_KEY = 'PROJ__CFG__KEY__';
export const API_ADDRESS = 'API_ADDRESS__';
export const SYSTEM_CONFIG_KEY = 'SYSTEM_CONFIG_KEY__';
...
// 流程编辑 设置
export const PROCESS_SETTING_KEY = 'PROCESS__SETTING__KEY__';

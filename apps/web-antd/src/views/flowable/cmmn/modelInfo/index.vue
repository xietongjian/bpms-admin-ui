<template>
  <PageWrapper v-loading="loadingRef" dense contentFullHeight fixedHeight>
    <div style="font-size: 30px; padding: 100px; color: #aaa; text-align: center"> 敬请期待！ </div>
    ...
    <BasicTable @register="registerTable" class="w-3/4 xl:w-4/5">
      <template #toolbar>
        ...
        &lt;!&ndash;<Authority value="ModelInfo:4">
...
<script lang="ts" setup>
  ...
  import { useTable, BasicColumn, ActionItem } from '@/components/Table';
